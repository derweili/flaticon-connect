...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__01_flaticon_sidebar__ = __webpack_require__(54);
/**
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2_babel_runtime_helpers_asyncToGenerator__ = __webpack_require__(60);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2_babel_runtime_helpers_asyncToGenerator___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_2_babel_runtime_helpers_asyncToGenerator__);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3_babel_runtime_core_js_object_get_prototype_of__ = __webpack_require__(86);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3_babel_runtime_core_js_object_get_prototype_of___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_3_babel_runtime_core_js_object_get_prototype_of__);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4_babel_runtime_helpers_classCallCheck__ = __webpack_require__(90);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4_babel_runtime_helpers_classCallCheck___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_4_babel_runtime_helpers_classCallCheck__);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_5_babel_runtime_helpers_createClass__ = __webpack_require__(91);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_5_babel_runtime_helpers_createClass___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_5_babel_runtime_helpers_createClass__);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_6_babel_runtime_helpers_possibleConstructorReturn__ = __webpack_require__(95);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_7_babel_runtime_helpers_inherits__ = __webpack_require__(107);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_7_babel_runtime_helpers_inherits___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_7_babel_runtime_helpers_inherits__);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_8__plugin_scss__ = __webpack_require__(115);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_8__plugin_scss___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_8__plugin_scss__);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_9__icon__ = __webpack_require__(116);
...
var DerweiliFlaticonSidebar = function (_Component) {
  __WEBPACK_IMPORTED_MODULE_7_babel_runtime_helpers_inherits___default()(DerweiliFlaticonSidebar, _Component);

  function DerweiliFlaticonSidebar() {
    var _ref,
        _this2 = this;

    var _temp, _this, _ret;

    __WEBPACK_IMPORTED_MODULE_4_babel_runtime_helpers_classCallCheck___default()(this, DerweiliFlaticonSidebar);

    for (var _len = arguments.length, args = Array(_len), _key = 0; _key < _len; _key++) {
      args[_key] = arguments[_key];
    }

    return _ret = (_temp = (_this = __WEBPACK_IMPORTED_MODULE_6_babel_runtime_helpers_possibleConstructorReturn___default()(this, (_ref = DerweiliFlaticonSidebar.__proto__ || __WEBPACK_IMPORTED_MODULE_3_babel_runtime_core_js_object_get_prototype_of___default()(DerweiliFlaticonSidebar)).call.apply(_ref, [this].concat(args))), _this), _this.state = {
      ...
      return __WEBPACK_IMPORTED_MODULE_1_babel_runtime_regenerator___default.a.wrap(function _callee$(_context) {
        while (1) {
          switch (_context.prev = _context.next) {
            case 0:
              _context.next = 2;
              return setApiKey(_this.state.apiKey);

            case 2:
              apiKey = _context.sent;


              _this.fetchApiToken(apiKey);
  ...
  __WEBPACK_IMPORTED_MODULE_5_babel_runtime_helpers_createClass___default()(DerweiliFlaticonSidebar, [{
    ...
    key: "importImage",
    value: function importImage(image_data) {

      return apiFetch({
        path: "/flaticon/v1/import-image",
        method: "POST",
        body: __WEBPACK_IMPORTED_MODULE_0_babel_runtime_core_js_json_stringify___default()({ image_data: image_data })
      }).then(function (blockSetting) {
    ...
    key: "onImportImage",
    value: function () {
      var _ref4 = __WEBPACK_IMPORTED_MODULE_2_babel_runtime_helpers_asyncToGenerator___default()( /*#__PURE__*/__WEBPACK_IMPORTED_MODULE_1_babel_runtime_regenerator___default.a.mark(function _callee3(icon) {
        var importingImages, imortedMedia, importedImages;
        return __WEBPACK_IMPORTED_MODULE_1_babel_runtime_regenerator___default.a.wrap(function _callee3$(_context3) {
          while (1) {
            switch (_context3.prev = _context3.next) {
              case 0:
                importingImages = this.state.importingImages;
                ...
                _context3.next = 5;
                return this.importImage(icon.imageData);

              case 5:
                imortedMedia = _context3.sent;
                importedImages = this.state.importedImages;
      ...
      function onImportImage(_x) {
        return _ref4.apply(this, arguments);
      }

      return onImportImage;
    }()
  }, {
    key: "insertImage",
    value: function insertImage(media) {
      console.log('insertImage', media);
      wp.data.dispatch('core/editor').insertBlock(createBlock('core/image', { id: media.id, url: media.url }));
    }
  }, {
    key: "createInfo",
    value: function createInfo(message) {
    ...
    value: function onSearch() {
      ...
      var url = 'https://api.flaticon.com/v2/search/icons?q=' + searchTerm;
      ...
      fetch(url, {
        ...
        var icons = data.data.map(function (icon) {
          return {
            id: icon.id,
  ...
  return DerweiliFlaticonSidebar;
}(Component);

registerPlugin("jsforwpadvgb-demo", {
  icon: __WEBPACK_IMPORTED_MODULE_9__icon__["a" /* default */],
...
var icon = wp.element.createElement(
    'svg',
    { id: 'Capa_1', xmlns: 'http://www.w3.org/2000/svg', width: '21px', height: '17px',
        viewBox: '0 0 108.9 91.8' },
    wp.element.createElement('path', { id: 'Shape_2_', className: 'st0', style: { fill: '#0e2a47' }, d: 'M44.2,50.5h11.4l10.1-16.7H33.9L23.4,16.7h52.8L86.4,0H8.5C5.4,0,2.6,1.6,1.1,4.2 c-1.5,2.6-1.5,5.9,0.1,8.4l46,75.1c1.5,2.5,4.3,4.1,7.2,4.1s5.7-1.5,7.2-4.1l2.7-4.3L44.2,50.5z'
    }),
    wp.element.createElement(
        'g',
        { id: 'Shape_3_' },
        wp.element.createElement('path', { className: 'st1', style: { fill: '#69e781' }, d: 'M21.8,16.7h19.8l2.5-4.1c1.5-2.5,1.6-5.8,0.1-8.4C42.7,1.6,39.9,0,36.8,0H32L21.8,16.7z',
            transform: 'translate(63.629)' }),
        wp.element.createElement('path', { className: 'st1', style: { fill: '#69e781' }, d: 'M17,24.7L-4.5,59.9L5.3,76l31.4-51.3L17,24.7z',
            transform: 'translate(63.629)' })
    )
);
