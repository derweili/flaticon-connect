...
function block_filters(){
	...
	wp_enqueue_script( 
		"derweili-flaticon-filters-js",
		_get_plugin_url() . $filters_js_path,
		['wp-hooks', 'lodash', 'derweili-flaticon-editor-js'],
